...
def solution_review(request):
    ...
    try:
        ...
        return render(request,'solutionfixer/no_unverified_remaining.html')
    ...
    return render(
        request,
        'solutionfixer/solution_review.html',
        {
            'solution':solution,
            'matches':matches,
...
def solution_summary(request, status=None):
    ...
    return render(
        request,
        'solutionfixer/solution_summary.html',
        context_dict
    )
...
def flagged_summary(request):
    ...
    return render(
        request,
        'solutionfixer/flagged_summary.html',
        context_dict
    )
...
def solution_pin_review(request, ingredient_id):
    ...
    return render(request, 'solutionfixer/solution_pin_review.html', context_dict)
