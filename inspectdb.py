...
class ExperimentalFormulas(models.Model):
    ...
    discontinued = models.BooleanField(db_column='Discontinued', default=False) # Field name made lowercase.
...
class ExperimentalProducts(models.Model):
    ...
    discontinued = models.BooleanField(db_column='Discontinued', default=False) # Field name made lowercase.
    approved = models.BooleanField(db_column='Approved', default=False) # Field name made lowercase.
    productmemo = models.TextField(db_column='ProductMemo') # Field name made lowercase.
    sold = models.BooleanField(db_column='Sold', default=False) # Field name made lowercase.
    spraydried = models.BooleanField(db_column='SprayDried', default=False) # Field name made lowercase.
...
class Experimentallog(models.Model):
    ...
    liquid = models.BooleanField(db_column='Liquid', default=False) # Field name made lowercase.
    dry = models.BooleanField(db_column='Dry', default=False) # Field name made lowercase.
    oilsoluble = models.BooleanField(db_column='OilSoluble', default=False) # Field name made lowercase.
    organic = models.BooleanField(db_column='Organic', default=False) # Field name made lowercase.
    duplication = models.BooleanField(db_column='Duplication', default=False) # Field name made lowercase.
    n/a = models.BooleanField(db_column='N/A', default=False) # Field name made lowercase.
    natural = models.BooleanField(db_column='Natural', default=False) # Field name made lowercase.
    ...
    concentrate = models.BooleanField(db_column='Concentrate', default=False) # Field name made lowercase.
    spraydried = models.BooleanField(db_column='Spray Dried', default=False) # Field renamed to remove spaces. Field name made lowercase.
    promotable = models.BooleanField(db_column='Promotable', default=False) # Field name made lowercase.
    holiday = models.BooleanField(db_column='Holiday', default=False) # Field name made lowercase.
    coffee = models.BooleanField(db_column='Coffee', default=False) # Field name made lowercase.
    tea = models.BooleanField(db_column='Tea', default=False) # Field name made lowercase.
    fruit = models.BooleanField(db_column='Fruit', default=False) # Field name made lowercase.
    sweet = models.BooleanField(db_column='Sweet', default=False) # Field name made lowercase.
    nutraceutical = models.BooleanField(db_column='Nutraceutical', default=False) # Field name made lowercase.
    personal_care = models.BooleanField(db_column='Personal Care', default=False) # Field renamed to remove spaces. Field name made lowercase.
    meat_and_savory = models.BooleanField(db_column='Meat and Savory', default=False) # Field renamed to remove spaces. Field name made lowercase.
    beverage = models.BooleanField(db_column='Beverage', default=False) # Field name made lowercase.
    chai = models.BooleanField(db_column='Chai', default=False) # Field name made lowercase.
    baked_goods = models.BooleanField(db_column='Baked Goods', default=False) # Field renamed to remove spaces. Field name made lowercase.
    dairy = models.BooleanField(db_column='Dairy', default=False) # Field name made lowercase.
    pet = models.BooleanField(db_column='Pet', default=False) # Field name made lowercase.
    snacks = models.BooleanField(db_column='Snacks', default=False) # Field name made lowercase.
    tobacco = models.BooleanField(db_column='Tobacco', default=False) # Field name made lowercase.
    non_food = models.BooleanField(db_column='Non-Food', default=False) # Field renamed to remove dashes. Field name made lowercase.
    wonf = models.BooleanField(db_column='WONF', default=False) # Field name made lowercase.
...
class ProductsSpecialInformation(models.Model):
    ...
    nutri_on_file = models.BooleanField(db_column='Nutri on File', default=False) # Field renamed to remove spaces. Field name made lowercase.
    ...
    label_check = models.BooleanField(db_column='Label_Check', default=False) # Field name made lowercase.
    vaporpressure = models.DecimalField(decimal_places=2, max_digits=4, db_column='VaporPressure') # Field name made lowercase.
    reactionextraction = models.BooleanField(db_column='ReactionExtraction', default=False) # Field name made lowercase.
    ...
    ccp1 = models.BooleanField(db_column='CCP1', default=False) # Field name made lowercase.
    ccp2 = models.BooleanField(db_column='CCP2', default=False) # Field name made lowercase.
    ccp3 = models.BooleanField(db_column='CCP3', default=False) # Field name made lowercase.
    ccp4 = models.BooleanField(db_column='CCP4', default=False) # Field name made lowercase.
    ccp5 = models.BooleanField(db_column='CCP5', default=False) # Field name made lowercase.
    ccp6 = models.BooleanField(db_column='CCP6', default=False) # Field name made lowercase.
    ...
    crustacean = models.BooleanField(db_column='Crustacean', default=False) # Field name made lowercase.
    eggs = models.BooleanField(db_column='Eggs', default=False) # Field name made lowercase.
    fish = models.BooleanField(db_column='Fish', default=False) # Field name made lowercase.
    milk = models.BooleanField(db_column='Milk', default=False) # Field name made lowercase.
    peanuts = models.BooleanField(db_column='Peanuts', default=False) # Field name made lowercase.
    soybeans = models.BooleanField(db_column='Soybeans', default=False) # Field name made lowercase.
    treenuts = models.BooleanField(db_column='TreeNuts', default=False) # Field name made lowercase.
    wheat = models.BooleanField(db_column='Wheat', default=False) # Field name made lowercase.
    sulfites = models.BooleanField(db_column='Sulfites', default=False) # Field name made lowercase.
    organic = models.BooleanField(db_column='Organic', default=False) # Field name made lowercase.
...
class RawMaterials(models.Model):
    ...
    supplierid = models.IntegerField(db_column='SupplierID') # Field name made lowercase.
    gmo = models.CharField(max_length=50, db_column='GMO') # Field name made lowercase.
    natural_document_on_file = models.BooleanField(db_column='Natural_Document_On_File', default=False) # Field name made lowercase.
    allergen = models.CharField(max_length=50, db_column='Allergen') # Field name made lowercase.
    sprayed = models.BooleanField(db_column='Sprayed', default=False) # Field name made lowercase.
    inventoryng = models.BooleanField(db_column='InventoryNG', default=False) # Field name made lowercase.
    kencheck = models.BooleanField(db_column='Kencheck', default=False) # Field name made lowercase.
    ...
    prop65 = models.BooleanField(db_column='Prop65', default=False) # Field name made lowercase.
    nutri = models.BooleanField(db_column='Nutri', default=False) # Field name made lowercase.
