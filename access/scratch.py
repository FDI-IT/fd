...
def ghs_ingredient_comparison():
    ...
    for ing in Ingredient.objects.all():
        try:
            ...
            fdi_only.append((ing.cas, ing.product_name))

    logger.info("GHS Ingredient CAS numbers not in our database: %s\n" % ghs_only)
    logger.info("FDI Ingredient CAS numbers not in the GHS document: %s\n" % fdi_only)            
    return ghs_only, fdi_only
