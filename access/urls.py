...
urlpatterns = patterns('access.views',
    ...
    (r'^ingredient/activate/(?P<raw_material_code>\d+)/$', 'rm_update_review'),
    (r'^ingredient/activate/discontinue_all/$', 'rm_update_review'),
    (r'^ingredient/pin_review/(?P<raw_material_id>\d+)/update_raw_materials/$', 'update_raw_materials'),
    ...
    (r'^ingredient/(?P<ingredient_rmc>\d+)/gzl/$', 'ingredient_gzl'),
