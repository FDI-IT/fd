'''
#Commenting entire file to make sure it is not needed
...
class Ingredient(models.Model):
    ...
    treenuts = models.BooleanField(blank=True, default=False)
...
class ExperimentalLog(models.Model):
    ...
    oilsoluble = models.BooleanField(db_column='OilSoluble', default=False)
    organic = models.BooleanField(db_column='Organic', default=False)
    duplication = models.BooleanField(db_column='Duplication', default=False)
    na = models.BooleanField(db_column='N/A', default=False)
...
class ExperimentalProduct(models.Model):
    ...
    productmemo = models.TextField(db_column='ProductMemo', default=False)
