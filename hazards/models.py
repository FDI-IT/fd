...
class HazardClass(models.Model):
    ...
    def __unicode__(self):
        return u"%s" % self.python_class_name
...
class HazardCategory(models.Model):
    hazard_class = models.ForeignKey('HazardClass')
    category = models.CharField(max_length=15)

    def __unicode__(self):
        return u"%s: %s" % (self.hazard_class.python_class_name, self.category)
...
class IngredientCategoryInfo(models.Model):
    ...
    ingredient = models.ForeignKey('GHSIngredient')
