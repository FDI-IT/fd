...
DATABASE_PASSWORD = 'flavor640'#os.environ['DJANGO_DATABASE_PASSWORD']         # Not used with sqlite3.
DATABASE_HOST = '192.168.10.9'#'192.168.1.129'#'10.1.10.182'#os.environ['DJANGO_DATABASE_HOST']             # Set to empty string for localhost. Not used with sqlite3.
