...
from LOCAL_SECRETS import REACT_SERVER
...
def search(request):
    ...
    try:
        context_dict['profile'] = request.user.userprofile
    except:
...
def flavor_search(request):
    return render(request, 'mysearch/flavor_search.html', {'react_server_address':REACT_SERVER})